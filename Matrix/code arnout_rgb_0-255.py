...
def solve_intensity_matrix(rho_multiplication_factor, nb_light_sources, light_source_intensity, surfaces):
    ...
    A_rho_R, A_rho_G, A_rho_B = [1-(1-R * rho_multiplication_factor)/255 for (R, G, B) in A_rho_RGB], \
                                [1-(1-G * rho_multiplication_factor)/255 for (R, G, B) in A_rho_RGB], \
                                [1-(1-B * rho_multiplication_factor)/255 for (R, G, B) in A_rho_RGB]
